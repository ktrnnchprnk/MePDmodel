...
errorbar([3.8,4.5,5.6,6.3,7.4,8.1,9.2,9.9], Mean(5:12), sd_data(5:12), 'k.', 'LineWidth', 1.5);
errorbar([0.2, 0.9], Mean(3:4), sd_data(3:4), 'k.', 'LineWidth', 1.5);
errorbar([0.2, 2.7], Mean(1:2), sd_data(1:2), 'k.', 'LineWidth', 1.5);
scatter(0.2, num_data(:,3),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(0.9, num_data(:,4),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(2, num_data(:,1),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(2.7, num_data(:,2),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
...
scatter(5.6, num_data(:,7),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(6.3, num_data(:,8),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(7.4, num_data(:,9),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
scatter(8.1, num_data(:,10),10, 'MarkerEdgeColor','k', 'MarkerFaceColor','w')
